...
class _HomeView extends GetView<HomeController> {
    ...
    return AppBar(
      ...
      flexibleSpace: Container(
        decoration: BoxDecoration(
          ...
          border: Border(bottom: BorderSide(color: AppTheme.primaryNeonCyan.withValues(alpha: 0.2), width: 1)),
        ),
      ),
    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: BottomNavigationBar(
          ...
          backgroundColor: AppTheme.surfaceDarkGlass,
          selectedItemColor: AppTheme.primaryNeonCyan,
  ...
  Widget _buildNavIcon(IconData icon, int index, {bool isActive = false}) {
    ...
    final selectedColor = AppTheme.primaryNeonCyan;
